export const reasons = [
  ...
  {
    id: 3,
    title: "Your smile is the reason for mine. 😊",
    emoji: "😊",
    badge: "Pure Joy ✨",
    content: "Seeing you smile automatically brings a smile to my face. Your happiness has become a part of mine.",
  ...
  {
    id: 5,
    title: "I am your Paglu. 🤍",
    emoji: "🤍",
    badge: "Favorite Identity 🤍",
    content: "No matter what happens, I'll always be your Paglu. That's my favorite identity.",
  ...
  },
  {
    ...
    emoji: "🫂",
    badge: "My Peace 🏡",
    content: "No matter how chaotic life gets, talking to you feels like coming home. You are my peace.",
    color: "from-teal-500/20 to-rose-500/20",
    accent: "#ff5a5f"
  },
  {
    id: 8,
    ...
    emoji: "✨",
    badge: "Pure Magic ✨",
    content: "Whether we're talking for hours or just sitting silently, every moment with you becomes a memory I never want to lose.",
    color: "from-purple-500/20 to-red-500/20",
    accent: "#ff85a1"
  },
  {
    id: 9,
    title: "You inspire me to become a better person. 🌸",
    emoji: "🌸",
    badge: "Growing Together 🌱",
    content: "Because of you, I want to grow, improve, and become someone who deserves your love every single day.",
    color: "from-emerald-500/20 to-red-500/20",
    accent: "#e01e37"
  },
  {
    id: 10,
